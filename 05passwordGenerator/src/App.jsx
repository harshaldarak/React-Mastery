...
function App() {
  ...
  return (
    <>
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 bg-gray-800 h-36'>
        <h1 className=' text-white text-2xl font-bold text-center mb-4 my-3'>
          Password Generator
        </h1>
        <div className='flex items-center shadow rounded-lg overflow-hidden mb-4 bg-white'>
          ...
          <button
            ...
            className='bg-blue-700 text-white px-4 py-2 text-sm hover:bg-blue-800'
          >
            {" "}
            Copy
          </button>
